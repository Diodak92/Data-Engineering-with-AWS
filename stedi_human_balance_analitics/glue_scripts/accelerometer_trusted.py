...
ON c.email = a.user;
'''
SQLQuery_node1744554471616 = sparkSqlQuery(glueContext, query = SqlQuery8443, mapping = {"accelerometer_landing":Accelerometerlanding_node1744554463149, "customer_trusted":Customertrusted_node1744554697864}, transformation_ctx = "SQLQuery_node1744554471616")
