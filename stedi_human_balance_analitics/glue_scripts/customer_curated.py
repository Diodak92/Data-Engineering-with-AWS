...
AND CAST(from_unixtime(s.sensorReadingTime / 1000) AS DATE) = c.lastUpdateDate;
'''
SQLQuery_node1744568567092 = sparkSqlQuery(glueContext, query = SqlQuery8348, mapping = {"customer_trusted":Customertrusted_node1744568555885, "step_trainer_landing":Steptrainerlanding_node1744568552850}, transformation_ctx = "SQLQuery_node1744568567092")
